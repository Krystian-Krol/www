...
var color = 1;
var c_click = 0;
var ps = document.getElementById('right_menu');
...
var p_form = document.getElementById('form');
...
console.log(document.getElementById('fname').innerText);
document.getElementById('lname').innerText = 'Kowalski';
